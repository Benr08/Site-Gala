...
<!-- End of prefooter section -->
 <div class="footer">
    <div class="container">
        <div class="row">
            <h5><?php echo esc_html__('Modifié par', 'sungit-lite'); ?></h5>
            <p class="copyright"><a href="<?php echo esc_url("https://yudleethemes.com");?>"><?php echo ' '.esc_html__('Benjamin R', 'sungit-lite'); ?></a></p>
        </div>
    </div>
</div>
