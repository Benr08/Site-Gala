				...
				<div class="col-md-12">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_accordion_shortcode_directory_url.'img/ac.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_accordion_shortcode_directory_url.'img/tabs-pro-screesnhot.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="tabs pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_accordion_shortcode_directory_url.'img/csp.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_accordion_shortcode_directory_url.'img/counters.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_accordion_shortcode_directory_url.'img/service-showcase-pro-preview.jpg'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
					...
					<div class="col-md-4"> 
							...
							<div class="wpsm-theme-container" style="">
								<img width="700" height="394" src="<?php echo wpshopmart_accordion_shortcode_directory_url.'img/cb.png'; ?>" class="wpsm_site-img-responsive wp-post-image" alt="Colorbox and panels pro plugin">
								<div class="wpsm_product_wrapper">
